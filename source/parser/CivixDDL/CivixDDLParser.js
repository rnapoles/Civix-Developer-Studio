...
function InvokeNewContext(parser, ctx) {
	ExpressionContext.call(this, parser);
    ExpressionContext.prototype.copyFrom.call(this, ctx);
    return this;
}

InvokeNewContext.prototype = Object.create(ExpressionContext.prototype);
InvokeNewContext.prototype.constructor = InvokeNewContext;

CivixDDLParser.InvokeNewContext = InvokeNewContext;

InvokeNewContext.prototype.TypeIdentifier = function() {
    return this.getToken(CivixDDLParser.TypeIdentifier, 0);
};

InvokeNewContext.prototype.arguments = function() {
    return this.getTypedRuleContext(ArgumentsContext,0);
};
InvokeNewContext.prototype.enterRule = function(listener) {
    if(listener instanceof CivixDDLListener ) {
        listener.enterInvokeNew(this);
	}
};

InvokeNewContext.prototype.exitRule = function(listener) {
    if(listener instanceof CivixDDLListener ) {
        listener.exitInvokeNew(this);
	}
};


function LiteralExpresionContext(parser, ctx) {
	ExpressionContext.call(this, parser);
    ExpressionContext.prototype.copyFrom.call(this, ctx);
    return this;
}

LiteralExpresionContext.prototype = Object.create(ExpressionContext.prototype);
LiteralExpresionContext.prototype.constructor = LiteralExpresionContext;

CivixDDLParser.LiteralExpresionContext = LiteralExpresionContext;

LiteralExpresionContext.prototype.literal = function() {
    return this.getTypedRuleContext(LiteralContext,0);
};
LiteralExpresionContext.prototype.enterRule = function(listener) {
    if(listener instanceof CivixDDLListener ) {
        listener.enterLiteralExpresion(this);
	}
};

LiteralExpresionContext.prototype.exitRule = function(listener) {
    if(listener instanceof CivixDDLListener ) {
        listener.exitLiteralExpresion(this);
	}
};
...
CivixDDLParser.prototype.expression = function() {
    ...
    try {
        ...
        switch(this._input.LA(1)) {
        case CivixDDLParser.NEW:
            localctx = new InvokeNewContext(this, localctx);
            this.enterOuterAlt(localctx, 1);
            this.state = 209;
        ...
        case CivixDDLParser.StringLiteral:
        case CivixDDLParser.NullLiteral:
            localctx = new LiteralExpresionContext(this, localctx);
            this.enterOuterAlt(localctx, 2);
            this.state = 212;
            this.literal();
            break;
