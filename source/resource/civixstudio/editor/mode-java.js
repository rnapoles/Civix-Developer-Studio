define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"),
        ...
        u = function (e) {
            var t = this.createKeywordMapper({
                "variable.language": "Cloneable|Serializable",
                keyword: "import|new|entity|extension|implements|extends|bigint|blob|boolean|date|datetime|decimal|float|int|smallint|string",
    ...
    var r = e("../lib/oop"),
        ...
        s = e("./text_highlight_rules").TextHighlightRules,
        o = function () {
            var e = "new|entity|extension|implements|extends|bigint|blob|boolean|date|datetime|decimal|float|int|smallint|string",
                t = "null|true|false",
                n = "Cloneable|Serializable",
