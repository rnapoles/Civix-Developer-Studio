define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"),
        ...
        s = e("./text_highlight_rules").TextHighlightRules,
        o = function () {
            var e = "abstract|continue|for|new|switch|assert|default|goto|package|synchronized|do|if|private|this|break|implements|protected|throw|else|import|public|throws|case|enum|instanceof|return|transient|catch|extends|try|final|interface|static|void|entity|extension|finally|strictfp|volatile|const|native|super|while|varbigint|blob|boolean|date|datetime|decimal|float|int|smallint|string|time",
